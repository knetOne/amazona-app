...
function ProductListScreen(props) {
    ...
    }, [dispatch, successCreate, props.history, createdProduct, successDelete, userInfo._id, sellerMode]);
    ...
    return (
        <div>
            <div className="row">
                <h1>Products</h1>
                <button className="primary" onClick={createHandler}>Create Product</button>
            </div>
