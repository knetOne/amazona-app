...
function PlaceOrderScreen(props) {
    ...
    const toPrice = (num) => Number(num.toFixed(2)); //5.235 => "5.23" => 5.23
                ...
                <div className="col-1">
                    <div className="card card-body">
                        <ul>
                            ...
                            <li>
                                <button type="button" onClick={placeOrderHandler} className="primary block" disable={cart.cartItems.length === 0}> Place Order</button>
                            </li>
                        </ul>
                    </div>
                </div>
